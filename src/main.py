...
def help_menu():
  print("""
    Available commands:
      ...
      lambda_update <function_name> <local_function_name> <o:environment>               - Deploys a new version of the specified lambda function.
      lambda_logs <function_name> <o:n> <o:filter_system_logs>                          - Fetches the last n logged messages of the specified lambda function.
...
def main():
    ...
    while True:
      ...
      if command == "deploy":
        ...
        if len(args) > 2:
          lambda_manager.update_function(args[0], args[1], json.loads(args[2]))
        else:
          lambda_manager.update_function(args[0], args[1])
